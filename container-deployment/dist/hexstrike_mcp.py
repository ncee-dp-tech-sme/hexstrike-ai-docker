...
def parse_args():
    ...
    parser.add_argument("--username", type=str, default=os.getenv("HEXSTRIKE_USERNAME"),
                      help="Username for basic authentication (or set HEXSTRIKE_USERNAME env var)")
    parser.add_argument("--password", type=str, default=os.getenv("HEXSTRIKE_PASSWORD"),
                      help="Password for basic authentication (or set HEXSTRIKE_PASSWORD env var)")
